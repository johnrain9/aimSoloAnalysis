...
- Closed GAP-005 (Medium): Derived lap/segment metrics now persisted during ingestion.
  - Evidence: commit `6f62753`, tests `tests/test_metrics_persistence_ingestion.py`.
  - Related requirements: RQ-ANL-003, RQ-DB-001.
- Closed GAP-010 (High): P0 insight contract fields and ranking constraints enforced.
  - Evidence: commit `395d812`, tests `tests/test_trackside_insight_contract.py`.
  - Related requirements: RQ-P0-005, RQ-P0-007, RQ-P0-008, RQ-P0-011, RQ-P0-012, RQ-P0-013, RQ-P0-016, RQ-P0-017, RQ-P0-018.
- Closed GAP-011 (Medium): Repeatable backend evaluation harness added with machine-readable report.
  - Evidence: commit `2df0b3e`, tests `tests/test_eval_backend.py`.
  - Related requirements: RQ-EVAL-001, RQ-EVAL-002, RQ-EVAL-003, RQ-EVAL-007, RQ-NFR-006.
...
- TASK-ANL-01: Wire `metrics_writer` into persistence path (RQ-ANL-003, RQ-DB-001).
