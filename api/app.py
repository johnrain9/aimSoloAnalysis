        ...
        items.append(
            {
                ...
                "did": convert_rider_text(insight.get("did")),
                "should": convert_rider_text(insight.get("should")),
                "because": convert_rider_text(insight.get("because")),
                "did_vs_should_status": insight.get("did_vs_should_status"),
                "did_vs_should_source": insight.get("did_vs_should_source"),
